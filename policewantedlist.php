...
if(isset($_POST['submit1']))
	...
	echo $sql1="INSERT INTO `wanted`(`name`, `place`,`image`,`description`,`height`,`weight`,`date`,`status`,`lid`) VALUES ('$name','$place','$file_name','$description','$height','$weight','$date',1,'$lid')";
...
<br><br><br>
<br><br><br>
<section class="page-title-section " data-background="images/0.jpg">
  <div class="container">
    <div class="row">
      <div class="col-md-8">
...
<section>
					 ...
					 <td> <input type="file"   class="form-control mb-3 "  
							name="image" placeholder="Image" id="img" onchange="validateImage()"/>
							<script>
    ...
    return true;
					 ...
					 <td> <input type="text"   class="form-control mb-3 " id="dl" 
							name="date" placeholder="date" av-message="invalid"/></td>
								<script>
  var d = new Date();
