...
$video_path=$_FILES['files']['name'];
  $description = $_POST["description"];
   // $s=$_POST['sub'];

   echo $sql1="INSERT INTO `videos`(`file`,`description`,`lid`) VALUES ('$video_path','$description','$lid')";
...
<br />
<label for="file"><span>description:</span></label>
...
<br>
<br>
<section class="page-title-section" data-background="images/lp.jpg">
  <div class="container">
    <div class="row">
      <div class="col-md-8">
...
<!--
                     <table align="center">
	<tr>			
<td><label for="file"><span>Filename:</span></label></td>
<td><input type="file" name="files" id="file"/></td> 
</tr>
<br>
<tr>
<td><label for="file"><span>Description:</span></label></td>
...
<input type="submit" name="submit" value="Submit"/></td></tr>
                    ...
                    <div class="col-12">
                        <input type="file" class="form-control mb-3" id="files" name="files">
                    </div>
                    <div class="col-12">
                        <input type="text" class="form-control mb-3" id="description" name="description" placeholder="Description">
                    </div>
