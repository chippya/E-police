...
if(isset($_POST['add']))
    {
        ...
        $rate=$_POST['rate'];
		 $sql1="INSERT INTO `accidentrates`(`locality`, `rate`,`status`) VALUES ('$locality','$rate',1)";
...
<!-- page title -->
<section class="page-title-section" width="400" data-background="images/s.jpg">
  <div class="container">
    <div class="row">
      <div class="col-md-8">
...
<section>
					 ...
					 <tr> <td> <label for="Locality" class="required">Locality</label></td>
...
<tr> <td> <label for="Accident Rate(yearly)" class="required">Accident Rate(yearly)</label></td>
<td> <input type="text"  name="rate" placeholder="Accident Rate"> </td>
</tr>
<tr align="center">
<td>
<input type="submit" value="Update" name="add" id="add"></td>
<td></tr>
					 </table>
</section>
<br><br>
...
<!-- footer -->
 ...
 <!-- <div class="newsletter">
  ...
  <!-- copyright -->
 <section class="page-title-section" width="400" data-background="images/e.jpg">
  <div class="container">
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb">
