...
if(isset($_POST['submit1']))
    {
		...
		$mobilenumber=$_POST['mobilenumber'];
		 $email=$_POST['email'];
		  $uid="SELECT `lid` FROM `login` WHERE `email`='$email'";
$result1=mysqli_query($con,$uid);
while($row=mysqli_fetch_array($result1))
{
  ...
  $uid=$row['lid'];
	...
	echo $sql1="INSERT INTO `petty`(`offense`, `address`,`mobilenumber`,`email`,`date`,`fine`,`area`,`status`,`lid`) VALUES ('$offense','$address','$mobilenumber','$uid','$date','$fine','$area',1,'$lid')";
...
<section>
					 ...
					 <tr>
					 <td>Offense</td>
					 <!--<td> <input type="text" size="100px" height="500px" rows="8" value='<?php echo $_GET['case']; ?>'  class="form-control mb-3 " id="Off" 
							name="off" placeholder="offense" av-message="invalid"/></td>-->
							<td><textarea class="form-control mb-3 " id="Offense" 
							name="offense" readonly ><?php echo $_GET['case']; ?> </textarea></td>
							<td> Address of Victim</td>
							<td><textarea class="form-control mb-3 " id="address" 
					 ...
					 <tr>
					 <td>Mobile Number </td>
					 <td> <input type="text"   class="form-control mb-3 av-mobile" id="mobilenumber" 
							name="mobilenumber" placeholder="mobilenumber" av-message="invalid"/></td>
							<td>Mailid</td>
					 <td> <input type="text"   class="form-control mb-3 av-email " id="email" 
							name="email" placeholder="mailid" av-message="invalid"/></td>
					 </tr>
					  <tr>
					 
							<td>Date of Case </td>
					 <td> <input type="text"   class="form-control mb-3 " id="dl" 
							name="date" placeholder="date" required readonly></td>
...
$('#dl').datepicker({ changeYear: true, changeMonth: true, maxDate:'d', minDate:'d', defaultDate: d})
					 ...
					 <td> <input type="text"   class="form-control mb-3 " id="fine" 
							name="fine" placeholder="fineamount" av-message="invalid" required /></td>
					 </tr>
					  <tr>
					  <td>Location of Case</td>
					   <td>
					   <select name="area">
