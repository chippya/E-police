...
<section>
  ...
  <tr>
    ...
    <th width="500" >Description of offence  </th>
    <th>Section/Rule</th>
	<th>Maximum of punishment Term of
Imprisonment/Fine  </th>
    <th>Select</th>
  </tr>
  <tr>
    <td>1</td>
    <td>Driving without holding an effective driving licence</td>
    <td>S.3r/wS. 181 of MV Act</td>
	<td>3months or Rs. 500 or both </td>
    <td>Select this</td>
  </tr>
  <tr>
    <td>2</td>
    <td>Driving by an under-aged person (Minor driving vehicle) </td>
    <td>S.4r/wS. 181 of MV Act </td>
	<td>3months or Rs. 500 or both </td>
    <td>Select this</td>
  </tr>
  <tr>
    <td>3</td>
    <td>Owner or person in-charge of a vehicle permitting an
unlicensed person or an under-aged person to drive it
(Parents/guardians/ friends permitting minor to drive vehicle)  </td>
    <td>S.5r/wS. 180 of MV Act  </td>
	<td>3months or Rs. 1000 or both 
 </td>
    <td>Select this</td>
  </tr>
  <tr>
     <td>4</td>
    <td>Holding of a driving licence permitting it to be used by other
person </td>
    <td>S.4r/wS. 181 of MV Act </td>
	<td> Rs. 100 for first offence </td>
    <td>Select this</td>
  </tr>
  <tr>
<td>5</td>
    <td>(i) Disqualified person driving a vehicle or (ii) applying for or
obtaining a driving licence or (iii) seeking a licence without
disclosing endorsements made on driving licence preciously
held </td>
    <td>S. 23r/wS. 182(1) of MV.Act </td>
	<td>3 month or Rs. 500 </td>
    <td a href="registerpetty.php">Select this</td>
  </tr>
